...
class Modulo3Web:
    ...
    def mostrar_predicciones(self):
        ...
        temperatura = st.number_input('Temperatura máxima (°C)', min_value=0.0, max_value=50.0)
        temperatura_min = st.number_input('Temperatura minima (°C)', min_value=0.0, max_value=50.0)
        humedad_aire = st.number_input('Humedad del aire (%)', min_value=0.0, max_value=100.0)
        precipitacion = st.number_input('Precipitación (mm)', min_value=0.0, max_value=1000.0)
